...
import { h as attributes, e as ensure_array_like, a as attr, k as attr_style, s as stringify } from "../../../chunks/index3.js";
import { H as Heading } from "../../../chunks/Heading.js";
import { f as formatSector } from "../../../chunks/utils3.js";
import { c as getSectors } from "../../../chunks/sector.remote.js";
import { B as Buildings, T as Tree, a as Trash } from "../../../chunks/Buildings.js";
        ...
        if (weight === "fill") {
          ...
          if (weight === "light") {
            ...
            if (weight === "regular") {
              ...
              if (weight === "thin") {
                $$renderer2.push("<!--[-->");
                $$renderer2.push(`<path d="M240,108H226.6L197.77,43.13a12,12,0,0,0-11-7.13H69.2a12,12,0,0,0-11,7.13L29.4,108H16a4,4,0,0,0,0,8H28v84a12,12,0,0,0,12,12H64a12,12,0,0,0,12-12V180H180v20a12,12,0,0,0,12,12h24a12,12,0,0,0,12-12V116h12a4,4,0,0,0,0-8ZM65.54,46.38A4,4,0,0,1,69.2,44H186.8a4,4,0,0,1,3.66,2.38L217.84,108H38.16ZM68,200a4,4,0,0,1-4,4H40a4,4,0,0,1-4-4V180H68Zm148,4H192a4,4,0,0,1-4-4V180h32v20A4,4,0,0,1,216,204Zm4-32H36V116H220ZM60,144a4,4,0,0,1,4-4H80a4,4,0,0,1,0,8H64A4,4,0,0,1,60,144Zm112,0a4,4,0,0,1,4-4h16a4,4,0,0,1,0,8H176A4,4,0,0,1,172,144Z"></path>`);
              } else {
                $$renderer2.push("<!--[!-->");
        ...
        if (weight === "fill") {
          ...
          if (weight === "light") {
            ...
            if (weight === "regular") {
              ...
              if (weight === "thin") {
                $$renderer2.push("<!--[-->");
                $$renderer2.push(`<path d="M248.5,114.81,181.05,46.9A92.1,92.1,0,0,0,50.9,47L37.12,61.18a4,4,0,1,0,5.75,5.56L56.6,52.56a83.75,83.75,0,0,1,22.34-16L130.34,88,31.51,186.82a12,12,0,0,0,0,17L52.2,224.48a12,12,0,0,0,17,0L168,125.63l17.17,17.18h0l17.66,17.66a12,12,0,0,0,17,0l28.69-28.69A12,12,0,0,0,248.5,114.81Zm-185,104a4,4,0,0,1-5.66,0L37.17,198.14a4,4,0,0,1,0-5.66L108,121.63,134.34,148ZM165.17,117.15,140,142.32,113.65,116,138.83,90.8a4,4,0,0,0,0-5.66l-52-52a84.11,84.11,0,0,1,88.52,19.38l47,47.35L188,134.32l-17.17-17.17A4,4,0,0,0,165.17,117.15Zm77.66,9-28.68,28.69a4,4,0,0,1-5.66,0L193.66,140l34.39-34.4,14.78,14.88A4,4,0,0,1,242.83,126.12Z"></path>`);
              } else {
                $$renderer2.push("<!--[!-->");
                $$renderer2.push(`${escape_html((console.error('Unsupported icon weight. Choose from "thin", "light", "regular", "bold", "fill", or "duotone".'), ""))}`);
              }
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    $$renderer2.async(async ($$renderer3) => {
      const sectors = (await save(getSectors()))();
      const sectorConfig = {
        waste: {
          icon: Trash,
          color: "rgb(139, 92, 46)",
      ...
      $$renderer3.push(`<div class="px-section-x py-section-y">`);
      Heading($$renderer3, {
        size: "h1",
        children: ($$renderer4) => {
          $$renderer4.push(`<!---->Emission Sectors`);
        },
        $$slots: { default: true }
      });
      $$renderer3.push(`<!----> `);
      if (!sectors) {
        $$renderer3.push("<!--[-->");
        $$renderer3.push(`<div class="flex min-h-[60vh] items-center justify-center"><div class="text-center"><div class="loading loading-spinner loading-lg text-primary"></div> <p class="mt-4 text-xs text-muted">Loading sectors...</p></div></div>`);
      } else {
        $$renderer3.push("<!--[!-->");
        $$renderer3.push(`<div class="grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-3"><!--[-->`);
        const each_array = ensure_array_like(sectors);
        for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
          let sector = each_array[$$index];
          const config = sectorConfig[sector] || { icon: Factory };
          $$renderer3.push(`<a${attr("href", `/sector/${stringify(sector)}`)} class="card bg-base-200 px-section-x flex justify-center transition-all group hover:bg-base-300 overflow-hidden relative min-h-[180px]"><div class="absolute inset-0 opacity-30 pointer-events-none"${attr_style(`background: linear-gradient(${stringify(config.gradient)}, ${stringify(config.color)}, transparent);`)}></div> <div class="z-10">`);
          Heading($$renderer3, {
            size: "h1",
            style: `color: ${stringify(config.color)};`,
            children: ($$renderer4) => {
              $$renderer4.push(`<!---->${escape_html(formatSector(sector))}`);
            },
            $$slots: { default: true }
          });
          $$renderer3.push(`<!----></div> <!---->`);
